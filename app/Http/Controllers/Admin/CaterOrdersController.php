...
use App\Models\Cater\CaterOrders;
use App\Models\Cater\CaterOrdersGoods;
use DB;
...
class CaterOrdersController extends Controller
{
    ...
    {
        return view('admin.cater.orders.index');
    }
    ...
    public function orderGoods(Request $request)
    {
        ...
        if ($order_id > 0) {
            ...
            return view('admin.cater.orders.order_goods', ['order_detail' => $order_detail, 'order_goods' => $order_goods]);
        }
    }
    ...
    public function reject_refund(Request $request)
    {
        ...
        return view('admin.cater.orders.reject_refund', ['order_id' => $order_id]);
    }
