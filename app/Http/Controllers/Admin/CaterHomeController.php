...
class CaterHomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("admin.cater.home.index", ['home_info' => $home_info]);
    }
    ...
    public function save(Request $request)
    {
        ...
        $shop_id = DB::table("cater_shop")->where(['admin_id' => Auth::guard()->user()->id, 'isvalid' => true])->value("id");
        //商家展示图
        if ($figure_img) {
        ...
        return redirect(route('cater.home.index'))->with(['status'=>'成功']);
    }
}