...
class CaterShopController  extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.cater.shop.index', [
            'provinces' => $provinces,
            'cities' => $cities,
            'countris' => $countris,
    ...
    public function map(Request $request)
    {
        ...
        return view("admin.cater.shop.map", [
    ...
    public function saveShop(Request $request)
    {
        ...
        return redirect(route('cater.shop.index'))->with(['status'=>'成功']);
    }
