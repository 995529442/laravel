...
use App\Models\Cater\CaterCategory;
use App\Models\Cater\CaterGoods;
...
class CaterGoodsController extends Controller
{
    ...
    {
        return view("admin.cater.goods.index");
    }
    ...
    public function data(Request $request)
    {
        ...
        $CaterGoods = DB::table("cater_goods as good")->where(['good.admin_id' => $admin_id, 'good.isvalid' => true])
            ...
            ->select(['good.id', 'good.good_name', 'good.is_hot', 'good.is_new', 'good.is_recommend', 'good.thumb_img',
                'good.original_price', 'good.now_price', 'good.introduce', 'cate.cate_name', 'good.isout', 'good.storenum',
                'good.sell_count']);
    ...
    public function add_goods(Request $request)
    {
        ...
        return view('admin.cater.goods.add_goods', [
    ...
    public function save_goods(Request $request)
    {
        ...
        return redirect(route('cater.goods.index'))->with(['status'=>'成功']);
    }
    ...
    public function del_goods(Request $request)
    {
        ...
        $goods = DB::table("cater_goods")->find($goods_id);
        if (!$goods){
